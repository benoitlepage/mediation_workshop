...
\NormalTok{model.tot.A.QoL }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(Y\_qol }\SpecialCharTok{\textasciitilde{}}\NormalTok{ A0\_ace }\SpecialCharTok{+}\NormalTok{ L0\_male }\SpecialCharTok{+}\NormalTok{ L0\_parent\_low\_educ\_lv,}
...
\CommentTok{\#   A0\_ace                 {-}5.0961     0.3486 {-}14.617  \textless{} 2e{-}16 *** \textless{}{-} Total effect}
\CommentTok{\#   L0\_male                {-}1.1486     0.2194  {-}5.235 1.68e{-}07 ***}
\CommentTok{\#   L0\_parent\_low\_educ\_lv  {-}3.4441     0.2295 {-}15.005  \textless{} 2e{-}16 ***}

\CommentTok{\# The total effect of ACE on Quality of life is approximately equal to {-}5.1,}
\CommentTok{\# given by the A0\_ace coefficient:}
\NormalTok{model.tot.A.QoL}\SpecialCharTok{$}\NormalTok{coefficients[}\StringTok{"A0\_ace"}\NormalTok{]}
\CommentTok{\# {-}5.096057}
...
\NormalTok{logit.model.A.M }\OtherTok{\textless{}{-}} \FunctionTok{glm}\NormalTok{(M\_smoking }\SpecialCharTok{\textasciitilde{}}\NormalTok{ A0\_ace }\SpecialCharTok{+}\NormalTok{ L0\_male }\SpecialCharTok{+}\NormalTok{ L0\_parent\_low\_educ\_lv,}
...
\CommentTok{\#   A0\_ace                 0.56168    0.06537   8.592  \textless{} 2e{-}16 *** \textless{}{-} effect of A on M}
\CommentTok{\#   L0\_male                0.25455    0.04425   5.753 8.77e{-}09 ***}
\CommentTok{\#   L0\_parent\_low\_educ\_lv  0.32683    0.04731   6.908 4.91e{-}12 ***}
\FunctionTok{exp}\NormalTok{(}\FunctionTok{coefficients}\NormalTok{(logit.model.A.M)[}\StringTok{"A0\_ace"}\NormalTok{])}
\CommentTok{\# Odds ratio = 1.753609  for the effect of ACE on the mediator (probability of smoking)}
...
\NormalTok{model.A.M.QoL }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(Y\_qol }\SpecialCharTok{\textasciitilde{}}\NormalTok{ A0\_ace }\SpecialCharTok{+}\NormalTok{ M\_smoking }\SpecialCharTok{+}\NormalTok{ L1 }\SpecialCharTok{+}\NormalTok{ L0\_male }\SpecialCharTok{+}\NormalTok{ L0\_parent\_low\_educ\_lv,}
                    \AttributeTok{data =}\NormalTok{ df1)}
\FunctionTok{summary}\NormalTok{(model.A.M.QoL)}
\CommentTok{\# Coefficients:}
\CommentTok{\#                         Estimate Std. Error t value Pr(\textgreater{}|t|)}
\CommentTok{\#   (Intercept)            74.7858     0.2130 351.178  \textless{} 2e{-}16 ***}
\CommentTok{\#   A0\_ace                 {-}3.9650     0.3212 {-}12.345  \textless{} 2e{-}16 *** \textless{}{-} Direct effect}
\CommentTok{\#   M\_smoking              {-}8.7138     0.2221 {-}39.237  \textless{} 2e{-}16 *** \textless{}{-} effect of M on Y}
\CommentTok{\#   L1                     {-}3.4252     0.2212 {-}15.483  \textless{} 2e{-}16 ***}
\CommentTok{\#   L0\_male                {-}0.7193     0.2017  {-}3.566 0.000364 ***}
\CommentTok{\#   L0\_parent\_low\_educ\_lv  {-}2.8876     0.2112 {-}13.674  \textless{} 2e{-}16 ***}

\CommentTok{\# The direct effect is approximately {-}4.0 given by the A0\_ace coefficient}
\NormalTok{model.A.M.QoL}\SpecialCharTok{$}\NormalTok{coefficients[}\StringTok{"A0\_ace"}\NormalTok{]}
\CommentTok{\# {-}3.965038}

\DocumentationTok{\#\# Following the Baron \& Kenny Steps, we would conclude that :}
\CommentTok{\# {-} There is a significant total effect of ACEs on Quality of Life (Model 1)}
\CommentTok{\# {-} There is a significant effect of ACEs on the mediator (smoking) (Model 2)}
\CommentTok{\# {-} There is a significant effect of the mediator (smoking) on Qol (model 3)}
\CommentTok{\# {-} The direct effect is significantly non{-}null}
\CommentTok{\# =\textgreater{} Conclusion: Smoking partially mediates the relationship between ACEs and QoL}
...
\NormalTok{ind.effect.dif.meth }\OtherTok{\textless{}{-}}\NormalTok{ (model.tot.A.QoL}\SpecialCharTok{$}\NormalTok{coefficients[}\StringTok{"A0\_ace"}\NormalTok{] }\SpecialCharTok{{-}}
\NormalTok{                          model.A.M.QoL}\SpecialCharTok{$}\NormalTok{coefficients[}\StringTok{"A0\_ace"}\NormalTok{])}
...
\NormalTok{linear.model.A.M }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(M\_smoking }\SpecialCharTok{\textasciitilde{}}\NormalTok{ A0\_ace }\SpecialCharTok{+}\NormalTok{ L0\_male }\SpecialCharTok{+}\NormalTok{ L0\_parent\_low\_educ\_lv,}
                       \AttributeTok{data =}\NormalTok{ df1)}
\FunctionTok{summary}\NormalTok{(linear.model.A.M)}
\CommentTok{\# Coefficients:}
\CommentTok{\#                         Estimate Std. Error t value Pr(\textgreater{}|t|)}
\CommentTok{\#   (Intercept)           0.215398   0.008929  24.123  \textless{} 2e{-}16 ***}
\CommentTok{\#   A0\_ace                0.127180   0.014446   8.804  \textless{} 2e{-}16 ***}
\CommentTok{\#   L0\_male               0.052363   0.009091   5.760 8.67e{-}09 ***}
\CommentTok{\#   L0\_parent\_low\_educ\_lv 0.065806   0.009511   6.919 4.83e{-}12 ***}

\DocumentationTok{\#\# product of coefficient method:}
\NormalTok{ind.effect.prod.meth }\OtherTok{\textless{}{-}}\NormalTok{ (linear.model.A.M}\SpecialCharTok{$}\NormalTok{coefficients[}\StringTok{"A0\_ace"}\NormalTok{] }\SpecialCharTok{*}
\NormalTok{                           model.A.M.QoL}\SpecialCharTok{$}\NormalTok{coefficients[}\StringTok{"M\_smoking"}\NormalTok{])}
\CommentTok{\# {-}1.108213}
...
\NormalTok{model.tot.A.death }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(Y\_death }\SpecialCharTok{\textasciitilde{}}\NormalTok{ A0\_ace }\SpecialCharTok{+}\NormalTok{ L0\_male }\SpecialCharTok{+}\NormalTok{ L0\_parent\_low\_educ\_lv,}
                        \AttributeTok{data =}\NormalTok{ df1)}
\FunctionTok{summary}\NormalTok{(model.tot.A.death)}
\CommentTok{\# Coefficients:}
\CommentTok{\#                         Estimate Std. Error t value Pr(\textgreater{}|t|)}
\CommentTok{\#   (Intercept)           0.135282   0.007909  17.104  \textless{} 2e{-}16 ***}
\CommentTok{\#   A0\_ace                0.060247   0.012796   4.708 2.53e{-}06 *** \textless{}{-} Total effect}
\CommentTok{\#   L0\_male               0.050285   0.008053   6.244 4.43e{-}10 ***}
\CommentTok{\#   L0\_parent\_low\_educ\_lv 0.059565   0.008425   7.070 1.65e{-}12 ***}
\CommentTok{\# On a risk difference scale the total effect of ACE on the probability of death is}
\CommentTok{\# approximately +6.0\%}
...
\NormalTok{model.A.M.death }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(Y\_death }\SpecialCharTok{\textasciitilde{}}\NormalTok{ A0\_ace }\SpecialCharTok{+}\NormalTok{ M\_smoking }\SpecialCharTok{+}\NormalTok{ L1 }\SpecialCharTok{+}\NormalTok{ L0\_male }\SpecialCharTok{+}\NormalTok{ L0\_parent\_low\_educ\_lv,}
                      \AttributeTok{data =}\NormalTok{ df1)}
\FunctionTok{summary}\NormalTok{(model.A.M.death)}
\CommentTok{\#   Coefficients:}
\CommentTok{\#                         Estimate Std. Error t value Pr(\textgreater{}|t|)}
\CommentTok{\#   (Intercept)           0.098691   0.008460  11.666  \textless{} 2e{-}16 ***}
\CommentTok{\#   A0\_ace                0.051509   0.012759   4.037 5.45e{-}05 *** \textless{}{-} Direct effect}
\CommentTok{\#   M\_smoking             0.064751   0.008822   7.340 2.31e{-}13 *** \textless{}{-} effect of M on Y}
\CommentTok{\#   L1                    0.075533   0.008788   8.595  \textless{} 2e{-}16 ***}
\CommentTok{\#   L0\_male               0.047490   0.008013   5.927 3.19e{-}09 ***}
\CommentTok{\#   L0\_parent\_low\_educ\_lv 0.055676   0.008389   6.637 3.36e{-}11 ***}


\CommentTok{\# The direct effect is approximately +5.2\% given by the A0\_ace coefficient}
\NormalTok{model.A.M.death}\SpecialCharTok{$}\NormalTok{coefficients[}\StringTok{"A0\_ace"}\NormalTok{]}
...
\NormalTok{model.tot.A.death}\SpecialCharTok{$}\NormalTok{coefficients[}\StringTok{"A0\_ace"}\NormalTok{] }\SpecialCharTok{{-}}\NormalTok{ model.A.M.death}\SpecialCharTok{$}\NormalTok{coefficients[}\StringTok{"A0\_ace"}\NormalTok{]}
...
\NormalTok{linear.model.A.M}\SpecialCharTok{$}\NormalTok{coefficients[}\StringTok{"A0\_ace"}\NormalTok{] }\SpecialCharTok{*}\NormalTok{ model.A.M.death}\SpecialCharTok{$}\NormalTok{coefficients[}\StringTok{"M\_smoking"}\NormalTok{]}
...
\hypertarget{ChapGcomp-CDE-param}{%
...
\NormalTok{data.Ais0.Mis0}\SpecialCharTok{$}\NormalTok{A0\_ace }\OtherTok{\textless{}{-}} \DecValTok{0}
\NormalTok{data.Ais0.Mis0}\SpecialCharTok{$}\NormalTok{M\_smoking }\OtherTok{\textless{}{-}} \DecValTok{0}

\NormalTok{data.Ais0.Mis1}\SpecialCharTok{$}\NormalTok{A0\_ace }\OtherTok{\textless{}{-}} \DecValTok{0}
\NormalTok{data.Ais0.Mis1}\SpecialCharTok{$}\NormalTok{M\_smoking }\OtherTok{\textless{}{-}} \DecValTok{1}

\NormalTok{data.Ais1.Mis0}\SpecialCharTok{$}\NormalTok{A0\_ace }\OtherTok{\textless{}{-}} \DecValTok{1}
\NormalTok{data.Ais1.Mis0}\SpecialCharTok{$}\NormalTok{M\_smoking }\OtherTok{\textless{}{-}} \DecValTok{0}

\NormalTok{data.Ais1.Mis1}\SpecialCharTok{$}\NormalTok{A0\_ace }\OtherTok{\textless{}{-}} \DecValTok{1}
\NormalTok{data.Ais1.Mis1}\SpecialCharTok{$}\NormalTok{M\_smoking }\OtherTok{\textless{}{-}} \DecValTok{1}
...
\hypertarget{g-computation-by-ice-using-the-ltmle-package}{%
...
\hypertarget{estimation-of-natural-direct-nde-and-indirect-effects-nie}{%
...
\hypertarget{estimation-of-marginal-randomizedinterventional-natural-direct-nde-and-indirect-effects-nie}{%
...
When we assume that the intermediate confounder \(L(1)\) of the \(M-Y\) relationship is affected by the exposure \(A\) (Causal model 2, Figure \ref{fig:figDAGM2}), an ``interventional analogue'' of the Average Total Effect decomposition into a Natural Direct and Indirect Effect has been suggested.Lin et al. (\protect\hyperlink{ref-lin2017}{2017}) For these effects, counterfactual scenarios are defined by setting different values for the exposure (\(A = 0\) or \(A=1\)) and random draw in the distribution \(G_{A=a^\prime \mid L(0)}\) of the mediator (conditional on baseline counfounders \(L(0)\)) under the counterfactual scenario setting \(A=a^\prime\).
...
\NormalTok{                       M\_smoking }\SpecialCharTok{+}\NormalTok{ A0\_ace}\SpecialCharTok{:}\NormalTok{M\_smoking,}
  ...
  \CommentTok{\# set the exposure A0\_ace to 0 or 1 in two new counterfactual data sets}
\NormalTok{  data.A0  }\OtherTok{\textless{}{-}}\NormalTok{ data.A1 }\OtherTok{\textless{}{-}}\NormalTok{ df2\_int}
\NormalTok{  data.A0}\SpecialCharTok{$}\NormalTok{A0\_ace }\OtherTok{\textless{}{-}} \DecValTok{0}
\NormalTok{  data.A1}\SpecialCharTok{$}\NormalTok{A0\_ace }\OtherTok{\textless{}{-}} \DecValTok{1}
  \CommentTok{\# simulate L1 values under the counterfactual exposures A0\_ace=0 or A0\_ace=1}
\NormalTok{  p.L1.A0 }\OtherTok{\textless{}{-}} \FunctionTok{predict}\NormalTok{(L1.model, }\AttributeTok{newdata =}\NormalTok{ data.A0, }\AttributeTok{type=}\StringTok{"response"}\NormalTok{)}
\NormalTok{  p.L1.A1 }\OtherTok{\textless{}{-}} \FunctionTok{predict}\NormalTok{(L1.model, }\AttributeTok{newdata =}\NormalTok{ data.A1, }\AttributeTok{type=}\StringTok{"response"}\NormalTok{)}
\NormalTok{  sim.L1.A0 }\OtherTok{\textless{}{-}} \FunctionTok{rbinom}\NormalTok{(}\AttributeTok{n =} \FunctionTok{nrow}\NormalTok{(df2\_int), }\AttributeTok{size =} \DecValTok{1}\NormalTok{, }\AttributeTok{prob =}\NormalTok{ p.L1.A0)}
\NormalTok{  sim.L1.A1 }\OtherTok{\textless{}{-}} \FunctionTok{rbinom}\NormalTok{(}\AttributeTok{n =} \FunctionTok{nrow}\NormalTok{(df2\_int), }\AttributeTok{size =} \DecValTok{1}\NormalTok{, }\AttributeTok{prob =}\NormalTok{ p.L1.A1)}
...
\NormalTok{  data.A1.L}\SpecialCharTok{$}\NormalTok{L1 }\OtherTok{\textless{}{-}}\NormalTok{ sim.L1.A1}
  ...
  \CommentTok{\# simulate M values under the counterfactual exposures A0\_ace=0 or A0\_ace=1}
...
\NormalTok{  data.A0.G0}\SpecialCharTok{$}\NormalTok{M\_smoking }\OtherTok{\textless{}{-}}\NormalTok{ marg.M.A0}
  \CommentTok{\# data.A0.G1$M\_smoking \textless{}{-} marg.M.A1 \# note: this data set will not be useful}

\NormalTok{  data.A1.G0}\SpecialCharTok{$}\NormalTok{M\_smoking }\OtherTok{\textless{}{-}}\NormalTok{ marg.M.A0}
\NormalTok{  data.A1.G1}\SpecialCharTok{$}\NormalTok{M\_smoking }\OtherTok{\textless{}{-}}\NormalTok{ marg.M.A1}
...
\NormalTok{G.model }\OtherTok{\textless{}{-}} \FunctionTok{glm}\NormalTok{(M\_smoking }\SpecialCharTok{\textasciitilde{}}\NormalTok{ L0\_male }\SpecialCharTok{+}\NormalTok{ L0\_parent\_low\_educ\_lv }\SpecialCharTok{+}\NormalTok{ A0\_ace,}
               \AttributeTok{family =} \StringTok{"binomial"}\NormalTok{, }\AttributeTok{data =}\NormalTok{ df2\_int)}
...
\hypertarget{using-the-cmaverse-package-for-2-way-3-way-and-4-way-decomposition}{%
...
\CommentTok{\# Call:}
\CommentTok{\#   glm(formula = Y\_qol \textasciitilde{} A0\_ace + M\_smoking + A0\_ace * M\_smoking +}
\CommentTok{\#         L0\_male + L0\_parent\_low\_educ\_lv + L1, family = gaussian(),}
...
\CommentTok{\#   A0\_ace                 {-}3.7014     0.4295  {-}8.617  \textless{} 2e{-}16 ***}
\CommentTok{\#   M\_smoking              {-}8.6336     0.2331 {-}37.042  \textless{} 2e{-}16 ***}
\CommentTok{\#   L0\_male                {-}0.7280     0.2019  {-}3.605 0.000313 ***}
\CommentTok{\#   L0\_parent\_low\_educ\_lv  {-}2.8828     0.2116 {-}13.621  \textless{} 2e{-}16 ***}
\CommentTok{\#   L1                     {-}5.1668     0.2189 {-}23.608  \textless{} 2e{-}16 ***}
\CommentTok{\#   A0\_ace:M\_smoking       {-}5.5119     0.6440  {-}8.559  \textless{} 2e{-}16 ***}

\DocumentationTok{\#\#\# 2) Estimation of g(M=1|L1,A,L0), model of the mediator}
\DocumentationTok{\#\#\# Mediator regressions:}
\CommentTok{\# Call:}
\CommentTok{\#   glm(formula = M\_smoking \textasciitilde{} A0\_ace + L0\_male + L0\_parent\_low\_educ\_lv +}
...
\CommentTok{\#   A0\_ace                 0.30994    0.06668   4.648 3.35e{-}06 ***}
\CommentTok{\#   L0\_male                0.24661    0.04369   5.644 1.66e{-}08 ***}
\CommentTok{\#   L0\_parent\_low\_educ\_lv  0.30628    0.04650   6.587 4.50e{-}11 ***}
...
\CommentTok{\# Call:}
\CommentTok{\#   glm(formula = L1 \textasciitilde{} A0\_ace + L0\_male + L0\_parent\_low\_educ\_lv,}
...
\CommentTok{\#   A0\_ace                 0.94354    0.06475  14.572  \textless{} 2e{-}16 ***}
\CommentTok{\#   L0\_male               {-}0.19827    0.04289  {-}4.622 3.80e{-}06 ***}
\CommentTok{\#   L0\_parent\_low\_educ\_lv  0.32047    0.04556   7.034 2.01e{-}12 ***}
...
\DocumentationTok{\#\# Check that MI = TE {-} rPNDE {-} rPNIE}
\NormalTok{(res\_gformula\_Qol\_M0}\SpecialCharTok{$}\NormalTok{effect.pe[}\StringTok{"te"}\NormalTok{] }\SpecialCharTok{{-}}\NormalTok{ res\_gformula\_Qol\_M0}\SpecialCharTok{$}\NormalTok{effect.pe[}\StringTok{"rpnde"}\NormalTok{] }\SpecialCharTok{{-}}
\NormalTok{    res\_gformula\_Qol\_M0}\SpecialCharTok{$}\NormalTok{effect.pe[}\StringTok{"rpnie"}\NormalTok{])}
\CommentTok{\# {-}0.897894}
\NormalTok{res\_gformula\_Qol\_M0}\SpecialCharTok{$}\NormalTok{effect.pe[}\StringTok{"rintmed"}\NormalTok{]}
\CommentTok{\# {-}0.897894 \# we have MI = TE {-} rPNDE {-} rPNIE}
...
\hypertarget{estimation-of-the-msm-coefficients-by-g-computation-imputation}{%
...
In order to fit the MSM \eqref{eq:MSMCDE}, we can use a linear regression of the (observed) outcome \(Y\) on the exposure and mediator, weighted by individual stabilized weights \(sw_i\) ((\protect\hyperlink{ref-vanderweele2009}{VanderWeele 2009})):
\begin{equation} 
...
\hypertarget{estimation-of-the-msm-coefficients-by-g-computation}{%
...
\NormalTok{Q.cde.death }\OtherTok{\textless{}{-}} \FunctionTok{glm}\NormalTok{(Y\_death }\SpecialCharTok{\textasciitilde{}}\NormalTok{ A0\_ace }\SpecialCharTok{+}\NormalTok{ M\_smoking }\SpecialCharTok{+}\NormalTok{ A0\_ace}\SpecialCharTok{:}\NormalTok{M\_smoking }\SpecialCharTok{+}\NormalTok{ L0\_male }\SpecialCharTok{+} 
\NormalTok{                     L0\_parent\_low\_educ\_lv }\SpecialCharTok{+}\NormalTok{ L1,}
                   \AttributeTok{family =} \StringTok{"gaussian"}\NormalTok{, }\AttributeTok{data =}\NormalTok{ df1\_int)}
...
\NormalTok{data.A0M0}\SpecialCharTok{$}\NormalTok{A0\_ace }\OtherTok{\textless{}{-}} \DecValTok{0}
\NormalTok{data.A0M0}\SpecialCharTok{$}\NormalTok{M\_smoking }\OtherTok{\textless{}{-}} \DecValTok{0}

\NormalTok{data.A1M0}\SpecialCharTok{$}\NormalTok{A0\_ace }\OtherTok{\textless{}{-}} \DecValTok{1}
\NormalTok{data.A1M0}\SpecialCharTok{$}\NormalTok{M\_smoking }\OtherTok{\textless{}{-}} \DecValTok{0}

\NormalTok{data.A0M1}\SpecialCharTok{$}\NormalTok{A0\_ace }\OtherTok{\textless{}{-}} \DecValTok{0}
\NormalTok{data.A0M1}\SpecialCharTok{$}\NormalTok{M\_smoking }\OtherTok{\textless{}{-}} \DecValTok{1}

\NormalTok{data.A1M1}\SpecialCharTok{$}\NormalTok{A0\_ace }\OtherTok{\textless{}{-}} \DecValTok{1}
\NormalTok{data.A1M1}\SpecialCharTok{$}\NormalTok{M\_smoking }\OtherTok{\textless{}{-}} \DecValTok{1}
...
\CommentTok{\# CDE(M=0) = E(Y\_\{A=1,M=0\}) {-} E(Y\_\{A=0,M=0\})}
\NormalTok{CDE\_mis0\_gcomp }\OtherTok{\textless{}{-}} \FunctionTok{coef}\NormalTok{(MSM.CDE.gcomp)[}\StringTok{"A0\_ace"}\NormalTok{]}
...
\DocumentationTok{\#\#    and baseline confounders L(0)}
\NormalTok{L1.death.A0M0.model }\OtherTok{\textless{}{-}} \FunctionTok{glm}\NormalTok{(Q.Y.death.A0M0 }\SpecialCharTok{\textasciitilde{}}\NormalTok{ L0\_male }\SpecialCharTok{+}\NormalTok{ L0\_parent\_low\_educ\_lv }\SpecialCharTok{+}\NormalTok{ A0\_ace,}
                           \AttributeTok{family =} \StringTok{"quasibinomial"}\NormalTok{, }\AttributeTok{data =}\NormalTok{ df2\_int)}
\NormalTok{L1.death.A1M0.model }\OtherTok{\textless{}{-}} \FunctionTok{glm}\NormalTok{(Q.Y.death.A1M0 }\SpecialCharTok{\textasciitilde{}}\NormalTok{ L0\_male }\SpecialCharTok{+}\NormalTok{ L0\_parent\_low\_educ\_lv }\SpecialCharTok{+}\NormalTok{ A0\_ace,}
                           \AttributeTok{family =} \StringTok{"quasibinomial"}\NormalTok{, }\AttributeTok{data =}\NormalTok{ df2\_int)}
\NormalTok{L1.death.A0M1.model }\OtherTok{\textless{}{-}} \FunctionTok{glm}\NormalTok{(Q.Y.death.A0M1 }\SpecialCharTok{\textasciitilde{}}\NormalTok{ L0\_male }\SpecialCharTok{+}\NormalTok{ L0\_parent\_low\_educ\_lv }\SpecialCharTok{+}\NormalTok{ A0\_ace,}
                           \AttributeTok{family =} \StringTok{"quasibinomial"}\NormalTok{, }\AttributeTok{data =}\NormalTok{ df2\_int)}
\NormalTok{L1.death.A1M1.model }\OtherTok{\textless{}{-}} \FunctionTok{glm}\NormalTok{(Q.Y.death.A1M1 }\SpecialCharTok{\textasciitilde{}}\NormalTok{ L0\_male }\SpecialCharTok{+}\NormalTok{ L0\_parent\_low\_educ\_lv }\SpecialCharTok{+}\NormalTok{ A0\_ace,}
                           \AttributeTok{family =} \StringTok{"quasibinomial"}\NormalTok{, }\AttributeTok{data =}\NormalTok{ df2\_int)}
...
\NormalTok{CDE\_ltmle\_M0 }\OtherTok{\textless{}{-}} \FunctionTok{ltmle}\NormalTok{(}\AttributeTok{data =}\NormalTok{ data\_binary,}
                      ...
                      \AttributeTok{SL.library =} \ConstantTok{NULL}\NormalTok{, }\CommentTok{\# call glm() instead of SuperLearner}
...
\hypertarget{expressing-the-nde-and-nie-using-coefficients-of-2-msms}{%
...
VanderWeele suggested using 2 MSMs conditional on baseline confounders \(L(0)\) in order to estimate natural direct and indirect effects (\protect\hyperlink{ref-vanderweele2009}{VanderWeele 2009}):
...
\hypertarget{estimation-of-the-2-msms-coefficients-by-iptw-for-nde-and-nie}{%
...
In order to fit the 1st MSM \eqref{eq:MSM-Indirect-model1}, we can use a linear regression of the (observed) outcome \(Y\) on the exposure and mediator, adjusted for \(L(0)\), weighted by individual stabilized weights \(sw_{msm1,i}\) (\protect\hyperlink{ref-vanderweele2009}{VanderWeele 2009}):
\begin{equation*} 
...
\NormalTok{g.M.AL0 }\OtherTok{\textless{}{-}} \FunctionTok{glm}\NormalTok{(M\_smoking }\SpecialCharTok{\textasciitilde{}}\NormalTok{ A0\_ace }\SpecialCharTok{+}\NormalTok{ L0\_male }\SpecialCharTok{+}\NormalTok{ L0\_parent\_low\_educ\_lv,}
               \AttributeTok{family =} \StringTok{"binomial"}\NormalTok{, }\AttributeTok{data =}\NormalTok{ df1\_int)}
...
\NormalTok{sw\_M.num[df1\_int}\SpecialCharTok{$}\NormalTok{M\_smoking}\SpecialCharTok{==}\DecValTok{1}\NormalTok{] }\OtherTok{\textless{}{-}}\NormalTok{ g.Mis1.AL0[df1\_int}\SpecialCharTok{$}\NormalTok{M\_smoking}\SpecialCharTok{==}\DecValTok{1}\NormalTok{]}
\NormalTok{sw\_M.num[df1\_int}\SpecialCharTok{$}\NormalTok{M\_smoking}\SpecialCharTok{==}\DecValTok{0}\NormalTok{] }\OtherTok{\textless{}{-}}\NormalTok{ (}\DecValTok{1} \SpecialCharTok{{-}}\NormalTok{ g.Mis1.AL0[df1\_int}\SpecialCharTok{$}\NormalTok{M\_smoking}\SpecialCharTok{==}\DecValTok{0}\NormalTok{])}

\NormalTok{g.M.AL0L1 }\OtherTok{\textless{}{-}} \FunctionTok{glm}\NormalTok{(M\_smoking }\SpecialCharTok{\textasciitilde{}}\NormalTok{ A0\_ace }\SpecialCharTok{+}\NormalTok{ L0\_male }\SpecialCharTok{+}\NormalTok{ L0\_parent\_low\_educ\_lv }\SpecialCharTok{+}\NormalTok{ L1,}
                 \AttributeTok{family =} \StringTok{"binomial"}\NormalTok{, }\AttributeTok{data =}\NormalTok{ df1\_int)}
...
\NormalTok{sw\_M.denom[df1\_int}\SpecialCharTok{$}\NormalTok{M\_smoking}\SpecialCharTok{==}\DecValTok{1}\NormalTok{] }\OtherTok{\textless{}{-}}\NormalTok{ g.Mis1.AL0L1[df1\_int}\SpecialCharTok{$}\NormalTok{M\_smoking}\SpecialCharTok{==}\DecValTok{1}\NormalTok{]}
\NormalTok{sw\_M.denom[df1\_int}\SpecialCharTok{$}\NormalTok{M\_smoking}\SpecialCharTok{==}\DecValTok{0}\NormalTok{] }\OtherTok{\textless{}{-}}\NormalTok{ (}\DecValTok{1} \SpecialCharTok{{-}}\NormalTok{ g.Mis1.AL0L1[df1\_int}\SpecialCharTok{$}\NormalTok{M\_smoking}\SpecialCharTok{==}\DecValTok{0}\NormalTok{])}
...
\NormalTok{MSM1 }\OtherTok{\textless{}{-}} \FunctionTok{glm}\NormalTok{(Y\_death }\SpecialCharTok{\textasciitilde{}}\NormalTok{ A0\_ace }\SpecialCharTok{+}\NormalTok{ M\_smoking }\SpecialCharTok{+}\NormalTok{ A0\_ace}\SpecialCharTok{:}\NormalTok{M\_smoking }\SpecialCharTok{+}
\NormalTok{              L0\_male }\SpecialCharTok{+}\NormalTok{ L0\_parent\_low\_educ\_lv,}
            \AttributeTok{weights =}\NormalTok{ sw\_msm1,}
            \AttributeTok{family =} \StringTok{"gaussian"}\NormalTok{,}
            \AttributeTok{data =}\NormalTok{ df1\_int)}
\FunctionTok{coef}\NormalTok{(MSM1)}
\CommentTok{\# (Intercept)                A0\_ace             M\_smoking}
\CommentTok{\#  0.12033221            0.06381257            0.06691712}
\CommentTok{\#     L0\_male L0\_parent\_low\_educ\_lv      A0\_ace:M\_smoking}
\CommentTok{\#  0.04671886            0.05521263            0.01652446}
...
\NormalTok{sw\_msm2.num[df1\_int}\SpecialCharTok{$}\NormalTok{A0\_ace}\SpecialCharTok{==}\DecValTok{1}\NormalTok{] }\OtherTok{\textless{}{-}}\NormalTok{ g.Ais1[df1\_int}\SpecialCharTok{$}\NormalTok{A0\_ace}\SpecialCharTok{==}\DecValTok{1}\NormalTok{]}
\NormalTok{sw\_msm2.num[df1\_int}\SpecialCharTok{$}\NormalTok{A0\_ace}\SpecialCharTok{==}\DecValTok{0}\NormalTok{] }\OtherTok{\textless{}{-}}\NormalTok{ (}\DecValTok{1} \SpecialCharTok{{-}}\NormalTok{ g.Ais1[df1\_int}\SpecialCharTok{$}\NormalTok{A0\_ace}\SpecialCharTok{==}\DecValTok{0}\NormalTok{])}

\CommentTok{\# denominator}
\NormalTok{g.A.L0 }\OtherTok{\textless{}{-}} \FunctionTok{glm}\NormalTok{(A0\_ace }\SpecialCharTok{\textasciitilde{}}\NormalTok{ L0\_male }\SpecialCharTok{+}\NormalTok{ L0\_parent\_low\_educ\_lv,}
              \AttributeTok{family =} \StringTok{"binomial"}\NormalTok{, }\AttributeTok{data =}\NormalTok{ df1\_int)}
...
\NormalTok{sw\_msm2.denom[df1\_int}\SpecialCharTok{$}\NormalTok{A0\_ace}\SpecialCharTok{==}\DecValTok{1}\NormalTok{] }\OtherTok{\textless{}{-}}\NormalTok{ g.Ais1.L0[df1\_int}\SpecialCharTok{$}\NormalTok{A0\_ace}\SpecialCharTok{==}\DecValTok{1}\NormalTok{]}
\NormalTok{sw\_msm2.denom[df1\_int}\SpecialCharTok{$}\NormalTok{A0\_ace}\SpecialCharTok{==}\DecValTok{0}\NormalTok{] }\OtherTok{\textless{}{-}}\NormalTok{ (}\DecValTok{1} \SpecialCharTok{{-}}\NormalTok{ g.Ais1.L0[df1\_int}\SpecialCharTok{$}\NormalTok{A0\_ace}\SpecialCharTok{==}\DecValTok{0}\NormalTok{])}
...
\NormalTok{MSM2 }\OtherTok{\textless{}{-}} \FunctionTok{glm}\NormalTok{(M\_smoking }\SpecialCharTok{\textasciitilde{}}\NormalTok{ A0\_ace }\SpecialCharTok{+}\NormalTok{ L0\_male }\SpecialCharTok{+}\NormalTok{ L0\_parent\_low\_educ\_lv,}
            \AttributeTok{weights =}\NormalTok{ sw\_msm2,}
            \AttributeTok{family =} \StringTok{"binomial"}\NormalTok{,}
            \AttributeTok{data =}\NormalTok{ df1\_int)}
\FunctionTok{coef}\NormalTok{(MSM2)}
\CommentTok{\# (Intercept)                A0\_ace               L0\_male L0\_parent\_low\_educ\_lv}
...
\NormalTok{g.minus1.A0 }\OtherTok{\textless{}{-}} \FunctionTok{plogis}\NormalTok{(}\FunctionTok{coef}\NormalTok{(MSM2)[}\StringTok{"(Intercept)"}\NormalTok{] }\SpecialCharTok{+} \FunctionTok{coef}\NormalTok{(MSM2)[}\StringTok{"A0\_ace"}\NormalTok{] }\SpecialCharTok{*} \DecValTok{0} \SpecialCharTok{+}
                      ...
                      \FunctionTok{coef}\NormalTok{(MSM2)[}\StringTok{"L0\_parent\_low\_educ\_lv"}\NormalTok{] }\SpecialCharTok{*}\NormalTok{ df1\_int}\SpecialCharTok{$}\NormalTok{L0\_parent\_low\_educ\_lv)}

\CommentTok{\# PNDE conditional on L(0)}
\NormalTok{PNDE\_L0 }\OtherTok{\textless{}{-}}\NormalTok{ (}\DecValTok{1} \SpecialCharTok{{-}} \DecValTok{0}\NormalTok{) }\SpecialCharTok{*}\NormalTok{ (}\FunctionTok{coef}\NormalTok{(MSM1)[}\StringTok{"A0\_ace"}\NormalTok{] }\SpecialCharTok{+}
                        \FunctionTok{coef}\NormalTok{(MSM1)[}\StringTok{"A0\_ace:M\_smoking"}\NormalTok{] }\SpecialCharTok{*}\NormalTok{ g.minus1.A0)}
...
\NormalTok{g.minus1.A1 }\OtherTok{\textless{}{-}} \FunctionTok{plogis}\NormalTok{(}\FunctionTok{coef}\NormalTok{(MSM2)[}\StringTok{"(Intercept)"}\NormalTok{] }\SpecialCharTok{+} \FunctionTok{coef}\NormalTok{(MSM2)[}\StringTok{"A0\_ace"}\NormalTok{] }\SpecialCharTok{*} \DecValTok{1} \SpecialCharTok{+}
                        \FunctionTok{coef}\NormalTok{(MSM2)[}\StringTok{"L0\_male"}\NormalTok{] }\SpecialCharTok{*}\NormalTok{ df1\_int}\SpecialCharTok{$}\NormalTok{L0\_male }\SpecialCharTok{+}
                        \FunctionTok{coef}\NormalTok{(MSM2)[}\StringTok{"L0\_parent\_low\_educ\_lv"}\NormalTok{] }\SpecialCharTok{*}\NormalTok{ df1\_int}\SpecialCharTok{$}\NormalTok{L0\_parent\_low\_educ\_lv)}
