...
\FunctionTok{set.seed}\NormalTok{(}\DecValTok{1234}\NormalTok{)}
\NormalTok{res\_gformula\_Qol }\OtherTok{\textless{}{-}} \FunctionTok{cmest}\NormalTok{(}\AttributeTok{data =}\NormalTok{ df2\_int, }\CommentTok{\#data.frame(df2\_int[,c("L0\_male",}
                                                       \CommentTok{\#"L0\_parent\_low\_educ\_lv",}
                                                       \CommentTok{\#"A0\_ace")],}
                                           \CommentTok{\#L1=as.factor(df2\_int$L1),}
                                           \CommentTok{\#df2\_int[,c("M\_smoking","Y\_qol")]),}
...
\FunctionTok{summary}\NormalTok{(res\_gformula\_Qol)}
