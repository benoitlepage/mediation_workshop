...
A0_PM2.5 ~ a.01 * L0_male
A0_PM2.5 ~ a.02 * L0_soc_env
M_diabetes ~ b.L01 * L0_male
M_diabetes ~ b.L02 * L0_soc_env
M_diabetes ~ b.A * A0_PM2.5
M_diabetes ~ b.L1 * L1
Y_qol ~ g.01 * L0_male
Y_qol ~ g.02 * L0_soc_env
Y_qol ~ g.A * A0_PM2.5
Y_qol ~ g.L1 * L1
Y_qol ~ g.M * M_diabetes
# direct effect
dir := g.A
#indirect effect
ind := b.A * g.M
...
# dir              -1.700    0.163  -10.445    0.000
# ind              -0.888    0.096   -9.253    0.000
# total            -2.587    0.170  -15.242    0.000
...
Y_death ~ g.02 * L0_soc_env
Y_death ~ g.A * A0_PM2.5
Y_death ~ g.L1 * L1
Y_death ~ g.M * M_diabetes
# direct effect
dir := g.A
#indirect effect
ind := b.A * g.M
