...
# ---------------------------------------------------------------------------- #
# 3) Estimation of the PNDE and TNIE by Inverse Odds Ratio Weigthing ----
# ---------------------------------------------------------------------------- #
...
# The approach is useful with multiple mediators, as we don't need to estimate
# a model for each mediator of interest.
# The IORW approach relies on :
#  - a single model of the exposure conditional on the set of mediators and baseline
#    confounders,
#  - and 2 models of the outcome, circonventing the need to specify the possible
...
## + Sensitivity analysis to test  confonding bias for the (in)direct effects
## described in Tchetgen Tchetchen & Sphister (2017),
##   and Nguyen et al (2015)

# ---------------------------------------------------------------------------- #
## 3.2) using the CMAverse ----
# ---------------------------------------------------------------------------- #
rm(list=ls())
df1_int <- read.csv(file = "data/df1_int.csv")
library(CMAverse)
...
# ---------------------------------------------------------------------------- #
# 4) Estimation of the Conditional Randomized Direct & Indirect Effects ----
# ---------------------------------------------------------------------------- #
