...
2. Estimate the joint distribution of time-varying confounders $L(1)$ and of the mediator ($M_{G_{A=0}}$ and $M_{G_{A=1}}$) under the counterfactual scenarios setting $A = 1$ or $A=0$;
